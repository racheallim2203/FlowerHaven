 ...
 *
 * @property \App\Model\Table\OrderFlowerTable $OrderFlower
 */
class OrderFlowerController extends AppController
{
     ...
     * View method
     *
     * @param string|null $id Order Flower id.
     * @return \Cake\Http\Response|null|void Renders view
     * @throws \Cake\Datasource\Exception\RecordNotFoundException When record not found.
     */
    public function view($id = null)
    {
        $orderFlower = $this->OrderFlower->get($id, contain: ['Flower', 'OrderDelivery']);
        $this->set(compact('orderFlower'));
    }
