...
class CategoriesTable extends Table
{
    ...
    public function validationDefault(Validator $validator): Validator
    {
        $validator
            ...
            ->maxLength('category_name', 32, 'The category name cannot exceed 32 characters.')
        ...
        $validator
            ...
            ->maxLength('category_description', 255, 'The category description cannot exceed 255 characters.')
