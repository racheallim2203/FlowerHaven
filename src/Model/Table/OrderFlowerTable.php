 ...
 * OrderFlower Model
 *
 * @property \App\Model\Table\FlowerTable&\Cake\ORM\Association\BelongsTo $Flower
...
class OrderFlowerTable extends Table
{
    ...
    {
        $rules->add($rules->existsIn(['flower_id'], 'Flower'), ['errorField' => 'flower_id']);
