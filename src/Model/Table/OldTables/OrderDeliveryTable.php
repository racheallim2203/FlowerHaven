 ...
 * OrderDelivery Model
 *
 * @property \App\Model\Table\OldTables\OrderStatusTable&\Cake\ORM\Association\BelongsTo $OrderStatus
 * @property \App\Model\Table\OldTables\DeliveryStatusTable&\Cake\ORM\Association\BelongsTo $DeliveryStatus
 *
 ...
 */
class OrderDeliveryTable extends Table
{
    /**
     * Initialize method
     *
    ...
    {
        $rules->add($rules->existsIn(['orderstatus_id'], 'OrderStatus'), ['errorField' => 'orderstatus_id']);
        $rules->add($rules->existsIn(['deliverystatus_id'], 'DeliveryStatus'), ['errorField' => 'deliverystatus_id']);
