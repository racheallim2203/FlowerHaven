 ...
 * @var iterable<\App\Model\Entity\OrderFlower> $orderFlowers
 */
?>
<div class="orderFlowers index content">
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php foreach ($orderFlowers as $orderFlower): ?>
                <tr>
                    ...
                    <td><?= $orderFlower->hasValue('order_delivery') ? $this->Html->link($orderFlower->order_delivery->id, ['controller' => 'OrderDeliveries', 'action' => 'view', $orderFlower->order_delivery->id]) : '' ?></td>
