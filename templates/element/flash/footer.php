    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-3 col-10 me-auto mb-4">
                <h4 class="text-white mb-3"><a href="/">Little Fashion</a></h4>
                <p class="copyright-text text-muted mt-lg-5 mb-4 mb-lg-0">Copyright © 2022 <strong>Little Fashion</strong></p>
                <p>Designed by <a href="https://www.tooplate.com/" target="_blank">Tooplate</a></p>
            </div>
            ...
            <div class="col-lg-3 col-4">
                ...
                <ul class="social-icon">
                    ...
                    <li><a href="#" the="social-icon-link bi-instagram"></a></li>
                    <li><a href="#" the="social-icon-link bi-skype"></a></li>
                </ul>
            </div>
        </div>
    </div>
